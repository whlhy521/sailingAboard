...
+ (MB_INSTANCETYPE)showTextHUDAddedTo:(UIView *)view Msg:(NSString*)msg animated:(BOOL)animated {
	MBProgressHUD *hud = [[self alloc] initWithView:view];
    hud.labelText = msg;
	[view addSubview:hud];
	[hud show:animated];
...
- (void)layoutSubviews {
	...
	CGSize labelSize = [label.text sizeWithFont:label.font constrainedToSize:CGSizeMake(maxWidth, 1000)];
